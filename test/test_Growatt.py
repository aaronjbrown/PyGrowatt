...
class TestGrowattPingResponse(TestCase):
    def test_encode(self):
        ...
        self.assertEqual(binascii.hexlify(_xor(data)), "06302c4625464773472a7761747447726f7761747447726f776174744772")


class TestGrowattAnnounceRequest(TestCase):
    def test_decode(self):
        data = binascii.unhexlify(
            "")
        request = Growatt.GrowattAnnounceRequest()
        request.decode(_xor(data))

        self.assertEqual(request.wifi_serial, 'XGD3A1968B')
        self.assertEqual(request.device_serial, 'XTD7A19031')
        ...
        # self.assertEqual(request.fw_version, 'AK1.0')
        # self.assertEqual(request.control_fw_version, 'ZAAA')
        self.assertEqual(request.device_type, '   PV Inverter  ')
